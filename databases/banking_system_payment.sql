...
CREATE TABLE `payment` (
  ...
  `pay_amt` decimal(20,5) DEFAULT NULL,
  `pay_date` datetime DEFAULT NULL,
  `loan_no` int DEFAULT NULL,
  PRIMARY KEY (`pay_no`),
  KEY `loan_no_pay_idx` (`loan_no`),
  CONSTRAINT `loan_no_pay` FOREIGN KEY (`loan_no`) REFERENCES `loan` (`loan_no`)
...
INSERT INTO `payment` VALUES (1,45000.00000,'2022-05-01 10:50:00',1);
