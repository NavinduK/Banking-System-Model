...
CREATE TABLE `employee` (
  ...
  CONSTRAINT `branch_no_emp` FOREIGN KEY (`branch_no`) REFERENCES `branch` (`branch_no`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `employee` VALUES (1,'Omar','Dubai',1);
