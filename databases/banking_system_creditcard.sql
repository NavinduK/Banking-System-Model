...
CREATE TABLE `creditcard` (
  ...
  PRIMARY KEY (`card_no`),
  KEY `acc_no_card_idx` (`acc_no`),
  CONSTRAINT `acc_no_card` FOREIGN KEY (`acc_no`) REFERENCES `account` (`acc_no`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `creditcard` VALUES ('1234567812345678',4343242.53540,'442432');
